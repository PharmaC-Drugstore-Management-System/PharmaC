          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex bg-gray-200 rounded-full p-0.5">
              <button
                ...
                className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-200 ${language === 'TH'
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex bg-gray-200 rounded-full p-0.5">
              <button
                ...
                className={`p-1.5 rounded-full transition-all duration-200 ${!darkMode
                  ? 'bg-teal-400 text-white shadow-sm'
                  : 'text-gray-600 hover:text-gray-800'
                  }`}
              >
