    ...
    <div className="flex h-screen bg-gray-50">
      <div className="flex-1 p-4 overflow-y-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <Link to="/RevenueDetail" className="lg:col-span-2">
            <div className="bg-white p-2 rounded-lg shadow cursor-pointer hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold mb-4">{t('revenue')}</h3>
          ...
          <div className="flex flex-col space-y-5.5">
            <div className="bg-white p-5 rounded-lg shadow">
              <h3 className="text-lg font-semibold">{t('amount_sales')}</h3>
        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-4">
          <div className="flex flex-col space-y-4">
            <div className="bg-white p-4 rounded-lg shadow">
              <h3 className="text-lg font-semibold">{t('total_items_in_stock')}</h3>
              <div className="text-4xl font-bold mt-2 text-center">1,500</div>
            </div>
            <div className="bg-white p-4 rounded-lg shadow">
              <h3 className="text-lg font-semibold">{t('total_items_sales')}</h3>
              <div className="text-4xl font-bold mt-2 text-center">10,000</div>
            </div>
            <div className="bg-white p-4 rounded-lg shadow">
              <h3 className="text-lg font-semibold">{t('profit')}</h3>
          ...
          <div className="bg-white p-2 rounded-lg shadow lg:col-span-1">
            <h3 className="text-lg font-semibold mb-2">{t('trend')}</h3>
            <div className="flex justify-center">
        ...
        <div className="bg-white p-4 rounded-lg shadow mt-4">
          <h3 className="text-lg font-semibold mb-4">{t('inventory_shortage')}</h3>
          <div>
