...
const rankedData = [...revenueDetailData].sort((a, b) => b.totalSale - a.totalSale).map((item, index) => ({
  ...item,
  rank: index + 1
}));
...
const renderRevenueRow = (item: { rank: any; id: any; name: any; productId: any; price: any; amount: any; totalSale: any; status: any; }) => {
  const rankColor =
